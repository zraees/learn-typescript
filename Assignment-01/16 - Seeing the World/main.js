...
*/
var places = ["Makkah", "Paris", "Madinah", "Finland", "Taj Mahal"];
var desc = function (a, b) { return a > b ? -1 : (a < b ? 1 : 0); }; // define desc func to use in sorting
...
console.log('array in reverse alphabetical order without modifying the actual list, ', places.slice().sort(desc));
console.log('\narray in its original order, ', places);
places.reverse();
